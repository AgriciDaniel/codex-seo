...
|---|---|
| `/seo bing links <url>` | `python ~/.codex/skills/seo/scripts/bing_webmaster.py links <url>` |
| `/seo bing compare <urlA> <urlB>` | `python ~/.codex/skills/seo/scripts/bing_webmaster.py compare <urlA> <urlB>`; both properties must be registered to the API account |
| `/seo bing submit <url>` (single URL) | `python ~/.codex/skills/seo/scripts/indexnow_submit.py --host ... --urls <url>` |
| `/seo bing submit-batch <file>` | `python ~/.codex/skills/seo/scripts/indexnow_submit.py --host ... --urls-file <file>` |
| `/seo bing verify-indexnow` | `python ~/.codex/skills/seo/scripts/indexnow_submit.py --host ... --verify-only` |
