...
2. Use `python ~/.codex/skills/seo/scripts/render_page.py <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
python ~/.codex/skills/seo/scripts/pagespeed_check.py URL --json

# SPA-aware HTML/render inspection
python ~/.codex/skills/seo/scripts/render_page.py URL --mode auto --json
...
```bash
python ~/.codex/skills/seo/scripts/pagespeed_check.py URL --json
python ~/.codex/skills/seo/scripts/crux_history.py URL --json
```
