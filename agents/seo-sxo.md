...
- Fetch the target URL using `python ~/.codex/skills/seo/scripts/render_page.py "<url>" --mode auto --json` (SPA-aware SSRF-protected renderer)
- Parse with `python ~/.codex/skills/seo/scripts/parse_html.py --url "<url>"` to extract SEO elements
