...
```bash
python ~/.codex/skills/seo/scripts/capture_screenshot.py URL --all --output screenshots/
python ~/.codex/skills/seo/scripts/render_page.py URL --mode auto --a11y-tree --json
```
