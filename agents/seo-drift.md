...
- `python ~/.codex/skills/seo/scripts/drift_baseline.py <url>` -- capture a new baseline
- `python ~/.codex/skills/seo/scripts/drift_compare.py <url>` -- compare current state to baseline
- `python ~/.codex/skills/seo/scripts/drift_history.py <url>` -- show change history
- `python ~/.codex/skills/seo/scripts/drift_report.py <file> --output report.html` -- generate HTML report
